...
def generate_launch_description():
    ...
    "world",
    default_value="/home/mrj/ros2_ws/src/gazebo_models_worlds_collection/worlds/test_zone.world",
    description="Full path to the custom Gazebo world file to load",
    )
